...
import { ConfirmationSummary, buildConfirmationMessage } from "@/components/register/ConfirmationSummary";
...
export default function SuccessPage() {
  ...
  const waUrl = buildWhatsAppUrl(PANITIA_KONFIRMASI_WA, buildConfirmationMessage(data));
