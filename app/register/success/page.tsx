...
} from "@/components/register/ConfirmationSummary";
import { buildWhatsAppUrl } from "@/lib/whatsapp";
import { PANITIA_KONFIRMASI_WA } from "@/lib/constants";
  ...
  if (!data) {
    return (
      <main className="min-h-screen bg-cream flex flex-col items-center justify-center px-4">
        <p className="text-emerald/60 font-sans mb-4">
  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <header className="fixed top-0 w-full z-50 bg-cream h-16 flex items-center px-4 border-b border-emerald/5">
        ...
        <h1 className="ml-4 font-serif text-lg font-semibold text-emerald">
          Konfirmasi
        </h1>
      </header>
        ...
        <div className="bg-emerald/5 border border-emerald/10 rounded-xl p-4">
          <div className="flex gap-3">
            ...
            <p className="text-emerald font-sans text-sm leading-relaxed">
              Setelah melakukan pendaftaran, silakan konfirmasi kehadiran Anda
              dengan mengirimkan pesan melalui WhatsApp ke panitia. Klik tombol
              &quot;Konfirmasi Pendaftaran&quot; di bawah untuk mengirimkan
