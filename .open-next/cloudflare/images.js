...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:megrfxxnmfovnhvbgetf\\.supabase\\.co)$)$", pathname: "^(?:\\/storage\\/v1\\/object\\/public\\/about-images(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
