...
export function CTASection({ contactWa }: CTASectionProps) {
  const waUrl = buildWhatsAppUrl(contactWa, "Assalamu'alaikum, saya ingin bertanya tentang Dauroh Manis Raya");
    ...
    <section id="cta" className="py-12 md:py-20 px-4">
      <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-cream leading-snug mb-5">
            Siap mengikuti{" "}
            <span className="text-gold">Dauroh Manis Raya</span>?
          </h2>

          <p className="text-cream/70 font-sans text-lg leading-relaxed mb-8 max-w-xl mx-auto">
            Jangan tunda lagi. Kuota peserta sangat terbatas demi menjaga kualitas interaksi dan kekhusyukan belajar.
          </p>
          ...
          <p className="text-cream/50 font-sans text-sm mt-6">
            * Pendaftaran ditutup otomatis jika kuota terpenuhi.
          </p>
        </div>
      </div>
    </section>
